...
// TODO: Multiplayer room functionality - temporarily disabled
...
const games = [
  {
    ...
    description: 'New puzzle every day at midnight IST. Fill in the words using the clues provided!',
    icon: Grid3X3,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-dark-bg dark:to-dark-surface">
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {/* Join Room Section - Temporarily disabled */}
          {/* <JoinRoomSection /> */}
